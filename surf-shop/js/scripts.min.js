...
$(function() {
  ...
  //$('.button-more').text('It is all :)')

	$('#nav-icon').click(function(){
		$(this).toggleClass('open');
		$('.top-menu').slideToggle('slow');
		//$('#nav-icon').next().slideToggle();
	});


	//owl-carousel with slider counter
...
/*creating click event for each tab menu*/
  $(document.body).on("click",".tab-link",function(){        
  ...
  /* $(this).parent().find(".tab-link").addClass('active-link');*/
  $(".tab-link[data-id='"+$(this).attr('data-id')+"']").addClass('active-link');
  });
...
;( function( $, window, document, undefined )
{
    ...
    $( form ).each( function()
    {
        ...
        {
            val = $email.val();
            $form.toggleClass( className, val != '' && /^([\w-\.]+@([\w-]+\.)+[\w-]{2,12})?$/.test( val ) ).fadeIn();
        });
    });
